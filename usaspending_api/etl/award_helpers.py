...
def update_awards(award_tuple=None):
    ...
    sql_update += (
        ...
        'period_of_performance_current_end_date = l.period_of_performance_current_end_date::DATE, '
        'period_of_performance_start_date = e.period_of_performance_start_date::DATE, '
